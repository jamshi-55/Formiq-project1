...
function Men() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
      ...
      <div className="flex flex-wrap justify-center gap-6 sm:gap-4 md:gap-6 lg:gap-8 mb-6 sticky top-32  z-50 bg-white">
        <button
        ...
        {products.length > 0 ? (
          products.map(product => (
            <Link
              ...
              key={product.id}
              className="border rounded-lg p-4 sm:p-5 bg-white shadow-md hover:shadow-lg transition"
            >
              <img
                src={product.image}
                alt={product.name}
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                <button
                  ...
                  className="w-full sm:w-auto px-3 py-1.5 sm:px-4 sm:py-2 bg-teal-600 text-white rounded-md text-sm sm:text-base hover:bg-teal-700 transition"
                >
                  Bag
                </button>
                <button
                  ...
                  className="w-full sm:w-auto px-3 py-1.5 sm:px-4 sm:py-2 bg-gray-200 text-gray-700 rounded-md text-sm sm:text-base hover:bg-gray-300 transition"
                >
                  Wishlist
                </button>
              </div>
